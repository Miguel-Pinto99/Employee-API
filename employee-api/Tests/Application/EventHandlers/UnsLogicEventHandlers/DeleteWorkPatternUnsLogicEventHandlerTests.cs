...
namespace PVSDashboard.Tests.Application.EventHandlers.UnsLogicEventHandlers
{
    public class DeleteWorkPatternUnsLogicEventHandlerTests
    {
        ...
        private readonly DeleteWorkPatternUnsLogicEventHandler _handler;

        public DeleteWorkPatternUnsLogicEventHandlerTests()
        {
            _mediatorMock = new Mock<IMediator>(MockBehavior.Strict);
            _handler = new DeleteWorkPatternUnsLogicEventHandler(_mediatorMock.Object);
        }
        ...
        public async Task HandleShouldCallDeleteWorkPatternUnsLogicEventAsyncOnWorkPatternRepository_WhenCommandIsSet()
        {
            ...
            var command = new DeleteWorkPatternLogicEvent(listWorkPatterns[0]);
