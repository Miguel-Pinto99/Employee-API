...
namespace employee_api.Tests.Timers
{
    public class BreakWorkPatternTests
    {
        ...
        public async Task BreakWorkPatternAsyncShouldReturnEmptyList_WhenInsertingEmptyList()
        {
            ...
            // Act
            List<WorkPatternPart> response = await _timerService
        ...
        [Fact(DisplayName = "BreakWorkPatternAsync should split the work pattern in two when user has two overlapping absents")]
        public async Task BreakWorkPatternAsyncShoudSplitReturnEmptyList()
        {
            // Arrange
            DateTime today = DateTime.Today;
        ...
        [Fact(DisplayName = "BreakWorkPatternAsync should split the work pattern in two when user has two overlapping absents")]
        public async Task BreakWorkPatternAsyncShoudSplitReturnEmptyList1()
        {
            // Arrange
            DateTime today = DateTime.Today;
            ...
            var absents = new List<Absent>
            {
                ...
                {
                    UserId = userId,
                    StartDate = new DateTime(today.Year, today.Month, today.Day, 8, 0, 0, DateTimeKind.Local),
                    EndDate = new DateTime(today.Year, today.Month, today.Day, 11, 0 , 0, DateTimeKind.Local),
                },
            };
        ...
        [Fact(DisplayName = "BreakWorkPatternAsync should split the work pattern in two when user has two overlapping absents")]
        public async Task BreakWorkPatternAsyncShoudSplitReturnEmptyList2()
        {
            // Arrange
            DateTime today = DateTime.Today;
        ...
        [Fact(DisplayName = "BreakWorkPatternAsync should split the work pattern in two when user has two overlapping absents")]
        public async Task BreakWorkPatternAsyncShoudSplitReturnEmptyList3()
        {
            // Arrange
            DateTime today = DateTime.Today;
